...
title: Next Create
type: Post
descri: Create a new Next.js application with `create-next-app`. Set up TypeScript, styles, and configure your `next.config.js` file.

auth: Saikumar
date: 2020-07-23
---

<Video id="Vn8W_eurjkA?si=LEZFA-ByLwozYFnZ" videoHost="youtube" />
